...
class TestSetupWorkerProfileExtensionWipe(unittest.TestCase):
    ...
    def _plant_extension(self, profile_dir: Path, ext_id: str, version: str, name: str) -> Path:
    ...
    def test_wipes_all_extension_files(self):
        ...
        self._plant_extension(worker_dir, "applypilotextensionid0000000000000", "2.0", "ApplyPilot Control Panel")
